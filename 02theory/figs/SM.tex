...
\begin{tikzpicture}[x=1.15*\SMTikzSize cm, y=1.15*\SMTikzSize cm,
  ...
  \draw[round] (-0.7,0.7) rectangle (5.0,-3.5);
  \draw[round] (-0.6,0.6) rectangle (4.7,-2.5);
  \draw[round] (-0.5,0.5) rectangle (4.4,-1.5);


  \node at(0, 0)   {\particle[fillStrongForce]
                   {$u$}        {up}       {\SI{2.2}{\mathrm{Me\kern -0.1em V\!/}c^2}}{$\nicefrac{1}{2}$}{$\nicefrac{2}{3}$}{R/G/B}};
  \node at(0,-1)   {\particle[fillStrongForce]
                   {$d$}        {down}    {\SI{4.7}{\mathrm{Me\kern -0.1em V\!/}c^2}}{$\nicefrac{1}{2}$}{$-\nicefrac{1}{3}$}{R/G/B}};
  \node at(0,-2)   {\particle[fillEForce]
                   {$e$}        {electron}       {\SI{511}{\mathrm{ke\kern -0.1em V\!/}c^2}}{$\nicefrac{1}{2}$}{$-1$}{}};
  \node at(0,-3)   {\particle[fillWeakForce]
                   {$\nu_e$}    {$e$ neutrino}         {$<\SI{2}{\mathrm{e\kern -0.1em V\!/}c^2}$}{$\nicefrac{1}{2}$}{}{}};
  \node at(1, 0)   {\particle[fillStrongForce]
                   {$c$}        {charm}   {\SI{1.27}{\mathrm{Ge\kern -0.1em V\!/}c^2}}{$\nicefrac{1}{2}$}{$\nicefrac{2}{3}$}{R/G/B}};
  \node at(1,-1)   {\particle[fillStrongForce]
                   {$s$}        {strange}  {\SI{96}{\mathrm{Me\kern -0.1em V\!/}c^2}}{$\nicefrac{1}{2}$}{$-\nicefrac{1}{3}$}{R/G/B}};
  \node at(1,-2)   {\particle[fillEForce]
                   {$\mu$}      {muon}         {\SI{106}{\mathrm{Me\kern -0.1em V\!/}c^2}}{$\nicefrac{1}{2}$}{$-1$}{}};
  \node at(1,-3)   {\particle[fillWeakForce]
                   {$\nu_\mu$}  {$\mu$ neutrino}    {$<\SI{190}{\mathrm{ke\kern -0.1em V\!/}c^2}$}{$\nicefrac{1}{2}$}{}{}};
  \node at(2, 0)   {\particle[fillStrongForce]
                   {$t$}        {top}    {\SI{173.2}{\mathrm{Ge\kern -0.1em V\!/}c^2}}{$\nicefrac{1}{2}$}{$\nicefrac{2}{3}$}{R/G/B}};
  \node at(2,-1)   {\particle[fillStrongForce]
                   {$b$}        {bottom}  {\SI{4.67}{\mathrm{Ge\kern -0.1em V\!/}c^2}}{$\nicefrac{1}{2}$}{$-\nicefrac{1}{3}$}{R/G/B}};
  \node at(2,-2)   {\particle[fillEForce]
                   {$\tau$}     {tauon}          {\SI{1777}{\mathrm{Me\kern -0.1em V\!/}c^2}}{$\nicefrac{1}{2}$}{$-1$}{}};
  \node at(2,-3)   {\particle[fillWeakForce]
  ...
  \node at(4.7,0.5){\particle[gray!40!white]
