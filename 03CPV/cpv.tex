...
\begin{equation}
\begin{aligned}
&\CP\big|\Bz\big> =e^{i\xi_i}\big|\Bzb\big>&&\CP\big|\Bzb\big>=e^{-i\xi_i}\big|\Bz\big>\,,&\\
&\CP\big|\,\f\,\big> =e^{i\xi_f}\big|\,\fbar\,\big>&&\CP\big|\,\fbar\,\big>=e^{-i\xi_f}\big|\,\f\,\big>\,.& \label{eq:CPTransInitFinal}
\end{aligned}
\end{equation}
...
As described above, the mixing of the flavour eigenstates \Bq and \Bqb is characterised by the mass difference \dm, the decay-width difference \DG and the ratio $q/p$.
...
\begin{equation}
\Gamma_{12}=\sum_f\big<\f\,\big|T\,\big|\Bq\big>^{\kern -0.08em *}\big<\f\,\big|T\,\big|\Bqb\big>\,.\label{eq:gamma12}
\end{equation}
...
Further, the ratio $q/p$ from \cref{eq:qoverp} can be expressed as
\begin{equation}
