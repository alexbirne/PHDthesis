...
\begin{document}
	\begin{tikzpicture}
		\begin{feynman}
			...
			\vertex[right=\BdToDpiPenguinSize*0.19 cm of a2] (a3);
			\vertex[right=\BdToDpiPenguinSize*0.28 cm of a3] (a4) {\small$\overline d$};
			...
			(a2) -- [boson, edge label'={\small$W^{+}$}] (d1),
			(a3) -- [boson, edge label'={\small$W^{-}$}] (d2),
			};
