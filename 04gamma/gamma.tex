...
A possibility for such determination is to extract $\gamma$ from \CP violation measurements in $\Bz\!\to\pip\pim$ and $\Bs\!\to\Kp\Km$ \cite{GammaInLoops}.
...
To briefly outline the strategy first the transition amplitudes and \CP observables for both decay modes will be introduced in the following:
...
Assuming the U-spin flavour symmetry to be exact implies that $d'=d$ and $\theta'=\theta$.
% This means that
