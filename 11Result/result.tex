...
The values for \Sf and \Sfbar are further interpreted in terms of the angles $\beta$ and $\gamma$, as well as the amplitude ratio $r$ and the strong phase $delta$ (see \cref{eq:DefSf} and \eqref{eq:DefSfbar}).
