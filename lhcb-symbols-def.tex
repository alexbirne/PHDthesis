...
\def\Bzb     {{\ensuremath{\Bbar{}^{\kern 0.06em 0}}}\xspace}
...
\def\Bqb     {{\ensuremath{\Bbar{}^{\kern 0.06em 0}_\quark}}\xspace}
...
\def\jpsi     {{\ensuremath{{\PJ\mskip -2mu/\mskip -1mu\Ppsi\mskip 1mu}}}\xspace}
...
\def\Lcbar   {{\ensuremath{\Lz^-_\cquark}}\xspace}
...
\def\Vud  {{\ensuremath{V^{\phantom{*}}_{{\kern -0.1em}\uquark\dquark}}}\xspace}
\def\Vcd  {{\ensuremath{V^{\phantom{*}}_{{\kern -0.1em}\cquark\dquark}}}\xspace}
\def\Vtd  {{\ensuremath{V^{\phantom{*}}_{{\kern -0.1em}\tquark\dquark}}}\xspace}
\def\Vus  {{\ensuremath{V^{\phantom{*}}_{{\kern -0.1em}\uquark\squark}}}\xspace}
\def\Vcs  {{\ensuremath{V^{\phantom{*}}_{{\kern -0.1em}\cquark\squark}}}\xspace}
\def\Vts  {{\ensuremath{V^{\phantom{*}}_{{\kern -0.1em}\tquark\squark}}}\xspace}
\def\Vub  {{\ensuremath{V^{\phantom{*}}_{{\kern -0.1em}\uquark\bquark}}}\xspace}
\def\Vcb  {{\ensuremath{V^{\phantom{*}}_{{\kern -0.1em}\cquark\bquark}}}\xspace}
\def\Vtb  {{\ensuremath{V^{\phantom{*}}_{{\kern -0.1em}\tquark\bquark}}}\xspace}
...
\newcommand{\Adir}{{\ensuremath{{\cal A}^{\mathrm dir}}}\xspace}
\newcommand{\Amix}{{\ensuremath{{\cal A}^{\mathrm mix}}}\xspace}
...
\newcommand{\WorWbar}{{\ensuremath{\kern 0.18em\optbar{\kern -0.18em \omega}{}\xspace}}}
...
\newcommand{\chisqip}{\ensuremath{\chi^2_{\mathrm IP}}\xspace}
\newcommand{\chisqvs}{\ensuremath{\chi^2_{\mathrm VS}}\xspace}
\newcommand{\chisqvtx}{\ensuremath{\chi^2_{\mathrm vtx}}\xspace}
...
\def\nonn {\ensuremath{\mathrm {\it{n^+}}\mbox{-}on\mbox{-}{\it{n}}}\xspace}
\def\ponn {\ensuremath{\mathrm {\it{p^+}}\mbox{-}on\mbox{-}{\it{n}}}\xspace}
\def\nonp {\ensuremath{\mathrm {\it{n^+}}\mbox{-}on\mbox{-}{\it{p}}}\xspace}
\def\cvd  {CVD\xspace}
